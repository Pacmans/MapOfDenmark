...
public enum RoadType {
  ...
  ROAD3M(5, new Color(193,205,193), 1), //3-6m
  OTHERROAD(5, new Color(193,205,193), 1), //PAS PÅ HVORDAN DEN SKULLE OVERSÆTTES
  PROJROAD6M(5, new Color(193,205,193), 1), //3-6 m
  SECONDARYWAYINTERSECTION(5, new Color(193,205,193), 1),
  OTHERROADTUNNEL(5, new Color(193,205,193), 1), // ANDEN VEJ
