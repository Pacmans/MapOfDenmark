...
public class xmlWriter{
	...
	Writer output = null;
	  ...
	  System.out.println(cords[lines[i+1][0]][0]);
	  System.out.println(cords[lines[i+1][0]][1]);
	  System.out.println(cords[lines[i+1][1]][0]);
	  System.out.println(cords[lines[i+1][1]][1]);
	  }
